          ...
          <div className="overflow-hidden rounded-lg shadow-lg bg-gray-800">
            <div className="px-4 py-2">
              ...
              <p className="pt-0 text-sm text-gray-400">
                SpotiNow is a backend project that brings you a seamless
                integration between your Spotify account and your app, allowing
                you to effortlessly showcase the currently playing song in
                real-time.
              </p>
            </div>
